package net.etalia.json2.stream;
...
public class JsonReader implements Closeable {
  ...
  private JsonReader(JsonReader parent) {
	  ...
	  System.arraycopy(parent.buffer, 0, this.buffer, 0, this.buffer.length);
	  this.lenient = parent.lenient;
	  this.limit = parent.limit;
	  this.lineNumber = parent.lineNumber;
	  this.lineStart = parent.lineStart;
	  this.peeked = parent.peeked;
	  this.peekedLong = parent.peekedLong;
	  this.peekedNumberLength = parent.peekedNumberLength;
	  this.peekedString = parent.peekedString;
	  this.pos = parent.pos;
	  System.arraycopy(parent.stack, 0, this.stack, 0, this.stack.length);
